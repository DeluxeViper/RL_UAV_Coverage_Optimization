...
class SquareMapEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Calculate reward based on average minimum distance between users and agents
        ...
        reward = -average_min_distance  # Negative reward for closer distances
...
# Usage
env = SquareMapEnv(map_size=50, num_users=50, num_agents=3, agent_velocity=0.03)
env.reset()
...
try:
    while True:
        ...
        env.render(mode='human')  # Pass 'human' to render, or another value to skip rendering
